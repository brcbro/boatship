/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 83d936e17949c2f487cf52356368c99f)
// Runtime types generated with workerd@1.20260903.1 2026-09-13 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	COMPOSIO_API_KEY: string;
	OPENROUTER_API_KEY: string;
	OPENROUTER_MODEL: string;
	BOATSHIP_SECRETS_MASTER_KEY: string;
	DATABASE_URL: string;
	DIRECT_URL: string;
	MESSAGE_ROOM: DurableObjectNamespace<import("./custom-worker").MessageRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./custom-worker");
		durableNamespaces: "MessageRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COMPOSIO_API_KEY" | "OPENROUTER_API_KEY" | "OPENROUTER_MODEL" | "BOATSHIP_SECRETS_MASTER_KEY" | "DATABASE_URL" | "DIRECT_URL">> {}
}
